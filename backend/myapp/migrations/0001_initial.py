# Generated by Django 4.2.21 on 2026-03-25 11:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Recepta',
            fields=[
                ('id_api', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unitat', models.CharField(choices=[('g', 'grams'), ('kg', 'kilograms'), ('ml', 'mililitres'), ('L', 'litres'), ('unitat', 'unitat'), ('unitats', 'unitats')], max_length=10)),
                ('data_caducitat', models.DateField(blank=True, null=True)),
                ('data_afegit', models.DateTimeField(auto_now_add=True)),
                ('producte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.producte')),
        ...
        migrations.CreateModel(
            name='IngredientRecepta',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantitat', models.FloatField()),
                ('unitat', models.CharField(max_length=10)),
                ('producte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.producte')),
                ('recepta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.recepta')),
            ],
            options={
